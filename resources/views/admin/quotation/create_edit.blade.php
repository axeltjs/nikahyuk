...
<div class="x_panel">
    ...
    <div class="x_content">
		...
		@else 
			{!! Form::model($data,['url' => [url('vendor/quotation')."/".$data->id],'method' => 'Put', 'files' => true]) !!}			
		@endif
...
<script>
	...
	$(document).ready(function(){
		...
		@if($method == "edit")
			cekCustomer({{ $data->customer_id }});
		@endif

		@if(Request::get("id"))
			cekCustomer({{ Request::get("id") }});
			$("#customer_id").val({{ Request::get("id") }}).change();
		@endif
	});
</script>
