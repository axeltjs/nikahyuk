...
<div class="page-title">
    <div class="title_left">
        <h3 class="title">Laporan User</h3>
    </div>
        ...
        <div class="x_content">
            <div class="col-md-12 col-sm-12">
                    ...
                    @foreach($users as $user)
                        <div class="col-md-4 col-sm-4 profile_details">
                            <div class="well profile_view" style="width:400px; min-height:220px; height:auto;">
                                ...
                                <div class="left col-sm-7">
                                    <h2>{{ $user->name }}</h2>
                                    <ul class="list-unstyled">
                                    <li><i class="fa fa-building"></i> Alamat: {{ $user->address }}</li>
                                    <li><i class="fa fa-phone"></i> Telepon: {{ $user->phone }}</li>
                                    <li><i class="fa fa-phone"></i> Email: {{ $user->email }}</li>
                                    </ul>
                                </div>
                                <div class="right col-sm-5 text-center">
                                    <img src="{{ $user->photo_format_url }}" alt="" style="width: 100px; height:100px;" class="img-circle img-fluid">
                                </div>
                                </div>
                                <div class=" bottom text-center">
                                <div class=" col-sm-6 emphasis">
                                    <button type="button" data-toggle="modal" data-target="#userModal{{ $user->id }}" class="btn btn-primary btn-sm">
                        ...
                        <!-- Modal -->
                        <div id="userModal{{ $user->id }}" class="modal fade" role="dialog">
                            <div class="modal-dialog modal-lg">
                                ...
                                <div class="modal-footer">
                                    <a target="__blank" href="{{ url('admin/laporan/user/cetak/'.$user->id) }}" class="btn btn-success">Cetak</a>
